...
<div class="container" style="margin-top: 10%">
	<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/course" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="name"
					placeholder="课程名" value="${course.name }" name="course">
			</div>
		</div>
		<div class="form-group">
				...
				<div class="col-sm-10"> 
					<select class="form-control" name="course">
						<c:forEach items="${academies }" var="a">
							<c:if test="${!empty course.cno }">
								<c:if test="${a.ano==course.ano }">
