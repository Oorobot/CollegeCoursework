...
//  二叉排序树方法声明及重载编译系统默认方法声明:
	...
	int LNodeCount(const BinTreeNode<ElemType>* p) const;
...
template <class ElemType>
int BinarySortTree<ElemType>::LNodeCount(const BinTreeNode<ElemType>* p) const
{
	return NodeCount(p->leftChild)
}
